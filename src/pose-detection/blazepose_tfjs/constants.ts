...
export const DEFAULT_BLAZEPOSE_DETECTOR_MODEL_URL =
    'http://oss.cache.ren/img/blazepose/detector/f16/model.json';
export const DEFAULT_BLAZEPOSE_LANDMARK_MODEL_URL_FULL =
    'http://oss.cache.ren/img/blazepose/landmark/full-f16/model.json';
export const DEFAULT_BLAZEPOSE_LANDMARK_MODEL_URL_LITE =
    'http://oss.cache.ren/img/blazepose/landmark/lite-f16/model.json';
export const DEFAULT_BLAZEPOSE_LANDMARK_MODEL_URL_HEAVY =
    'http://oss.cache.ren/img/blazepose/landmark/heavy-f16/model.json';
