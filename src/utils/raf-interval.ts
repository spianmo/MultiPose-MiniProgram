...
export function setRafInterval(fn: Function, interval: number) {
    id++
...
export function clearRafInterval(id:number) {
    let i = 0,
        len = queue.length
...
function each(arr: Array<Function>, fn: Function) {
