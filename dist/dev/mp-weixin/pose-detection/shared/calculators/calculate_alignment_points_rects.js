"use strict";
const poseDetection_shared_calculators_detection_to_rect = require("./detection_to_rect.js");
/**
 * @license
...
function calculateAlignmentPointsRects(detection, imageSize, config) {
  ...
  const rotation = poseDetection_shared_calculators_detection_to_rect.computeRotation(detection, imageSize, config);
  return {
