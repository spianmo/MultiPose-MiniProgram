...
class RelativeVelocityFilter {
  constructor(config) {
    ...
    __publicField(this, "lowPassFilter", new poseDetection_calculators_low_pass_filter.LowPassFilter(1));
  ...
  apply(value, microSeconds, valueScale) {
    ...
    if (this.lastTimestamp === -1) {
      ...
      const assumedMaxDuration = poseDetection_calculators_constants.SECOND_TO_MICRO_SECONDS / 30;
      ...
      const velocity = cumulativeDistance / (cumulativeDuration * poseDetection_calculators_constants.MICRO_SECONDS_TO_SECOND);
